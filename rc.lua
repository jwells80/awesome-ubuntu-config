...
local browser1          = "microsoft-edge-stable"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn( browser1 ) end,
        {description = "Edge Browser", group = "Apps"}),
    awful.key({ modkey }, "d",
    function ()
        awful.spawn(string.format("rofi -show drun", beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
    end,
    {description = "show rofi", group = "hotkeys"}),

    -- kitty-terminal --drop-down
    awful.key({ }, "F12", function () awful.util.spawn( "tdrop -ma -w 60% -h 50% -x 20% -y 25% kitty" ) end,
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "thunderbird" ) end,
        {description = "Thunderbird (email)", group = "Apps"}),
    ...
    awful.key({ }, "Print", function () awful.util.spawn("flameshot gui --path /home/jason/Pictures/Screenshots") end,
        {description = "Scrot", group = "screenshots"}),
 ...
 -- Show/Hide Systray
    ...
    -- Calculator button
    awful.key({ }, "XF86Calculator", function () awful.spawn("tdrop -ma -w 324 -h 222 -x 40% -y 35% mate-calc") end),
...
awful.rules.rules = {
    ...
    { rule = {type = "dialog" },
        ...
        callback = function (c)
            ...
            end }, -- Centered dialog's for attention.
...
awful.spawn.with_shell("daily-wall")
